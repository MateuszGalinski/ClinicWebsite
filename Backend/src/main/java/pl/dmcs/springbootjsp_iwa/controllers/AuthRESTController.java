...
import pl.dmcs.springbootjsp_iwa.message.request.SignUpFormDoctor;
import pl.dmcs.springbootjsp_iwa.message.request.SignUpFormPatient;
...
public class AuthRESTController {
    ...
    public ResponseEntity<?> registerDoctor (@Valid @RequestBody SignUpFormDoctor signUpRequest) {
        ...
        Doctor doctor = new Doctor(signUpRequest.getName(), signUpRequest.getSurname(), signUpRequest.getSpecialization());
        doctor.setUser(user);
    ...
    public ResponseEntity<?> registerPatient (@Valid @RequestBody SignUpFormPatient signUpRequest) {
        ...
        Role doctorRole = roleRepository.findByName(RoleName.ROLE_USER)
                .orElseThrow(() -> new RuntimeException("Fail -> Cause: USER Role not found."));
        roles.add(doctorRole);
        ...
        Patient patient = new Patient(signUpRequest.getName(), signUpRequest.getSurname(), signUpRequest.getTelephone());
